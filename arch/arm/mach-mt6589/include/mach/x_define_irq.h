...
X_DEFINE_IRQ(MT6589_USB0_IRQ_ID            , 64, L,LEVEL)
X_DEFINE_IRQ(MT6589_USB1_IRQ_ID            , 65, L,LEVEL)
...
X_DEFINE_IRQ(MT6589_HIF_PDMA_IRQ_ID        , 91, L,LEVEL)
...
X_DEFINE_IRQ(MT6589_SPI1_IRQ_ID            , 110, L,LEVEL)
...
X_DEFINE_IRQ(MT6589_APARM_GPTTIMER_IRQ_LINE, 144, L,LEVEL)
X_DEFINE_IRQ(MT_EINT_IRQ_ID                , 145, H,LEVEL)
X_DEFINE_IRQ(EINT_EVENT_IRQ_ID             , 146, L,LEVEL)
X_DEFINE_IRQ(MT6589_PMIC_WRAP_IRQ_ID       , 147, H,LEVEL)
...
X_DEFINE_IRQ(MT6589_JPEG_ENC_IRQ_ID        , 173, L,LEVEL)
...
X_DEFINE_IRQ(MT6589_DISP_MDP_RDMA_IRQ_ID   , 178, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_MDP_RSZ0_IRQ_ID   , 179, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_MDP_RSZ1_IRQ_ID   , 180, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_MDP_TDSHP_IRQ_ID  , 181, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_MDP_WDMA_IRQ_ID   , 182, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_MDP_WROT_IRQ_ID   , 183, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_RDMA_IRQ_ID       , 184, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_OVL_IRQ_ID        , 185, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_WDMA_IRQ_ID       , 186, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_BLS_IRQ_ID        , 187, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_COLOR_IRQ_ID      , 188, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_DSI_IRQ_ID        , 189, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_DPI0_IRQ_ID       , 190, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_CMDQ_IRQ_ID       , 191, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_CMDQ_SECURE_IRQ_ID, 192, L,LEVEL)
X_DEFINE_IRQ(MT6589_DISP_MUTEX_IRQ_ID      , 193, L,LEVEL)
