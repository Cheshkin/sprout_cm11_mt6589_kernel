...
#if defined(CONFIG_MTK_HDMI_SUPPORT) ||defined (CONFIG_MTK_WFD_SUPPORT)
...
{
#if defined(CONFIG_MTK_WFD_SUPPORT) || defined(CONFIG_MTK_HDMI_SUPPORT)
		int tl = 0;
...
#if 0///defined(CONFIG_MTK_HDMI_SUPPORT)
